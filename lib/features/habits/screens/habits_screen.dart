            ...
            Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Text('${progress.done}/${progress.total}', style: TextStyle(fontFamily: 'Roboto', fontSize: 20, fontWeight: FontWeight.w700, color: progress.pct == 1.0 ? AppColors.deen : AppColors.gold)),
                ]),
                const Gap(10),
                ClipRRect(
                ...
                const Gap(6),
                Text(DateFormat('EEEE, d MMMM yyyy').format(DateTime.now()), style: const TextStyle(fontFamily: 'Roboto', fontSize: 10, color: AppColors.textSecondary)),
              ]),
        ...
        child: AnimatedContainer(
          ...
          child: Row(children: [
            ...
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(children: [
                if (habit.streak > 0) ...[
                  Text('🔥 ${habit.streak} day streak', style: const TextStyle(fontFamily: 'Roboto', fontSize: 10, color: AppColors.gold)),
                  const Gap(8),
                ] else ...[
                  const Text('No streak yet', style: TextStyle(fontFamily: 'Roboto', fontSize: 10, color: AppColors.textSecondary)),
                  const Gap(8),
                ],
                if (habit.longestStreak > 0)
                  Text('best: ${habit.longestStreak}', style: const TextStyle(fontFamily: 'Roboto', fontSize: 9, color: AppColors.textSecondary)),
              ]),
            ])),
            GestureDetector(
