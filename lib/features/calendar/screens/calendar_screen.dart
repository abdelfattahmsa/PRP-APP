          ...
          return Column(children: [
            ...
            TableCalendar<CalendarEvent>(
              ...
              calendarStyle: CalendarStyle(
                ...
                defaultTextStyle: const TextStyle(color: AppColors.textPrimary, fontFamily: 'IBMPlexMono', fontSize: 12),
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const Gap(14),
          // Date picker
          const Text('Date', style: TextStyle(fontSize: 10, color: AppColors.textSecondary, fontFamily: 'IBMPlexMono', letterSpacing: 0.5)),
          const Gap(6),
          GestureDetector(
            onTap: _pickDate,
            child: Container(
          ...
          const Gap(14),
          // Event type
          const Text('Type', style: TextStyle(fontSize: 10, color: AppColors.textSecondary, fontFamily: 'IBMPlexMono', letterSpacing: 0.5)),
          const Gap(6),
          Wrap(
