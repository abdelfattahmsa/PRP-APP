          ...
          return Column(children: [
            ...
            TableCalendar<CalendarEvent>(
              ...
              calendarStyle: CalendarStyle(
                ...
                weekendTextStyle: const TextStyle(color: AppColors.gold, fontSize: 12),
                selectedDecoration: const BoxDecoration(color: AppColors.gold, shape: BoxShape.circle),
                selectedTextStyle: const TextStyle(color: AppColors.bg, fontSize: 12, fontWeight: FontWeight.w700),
                ...
                todayTextStyle: const TextStyle(color: AppColors.gold, fontSize: 12),
              ...
              headerStyle: HeaderStyle(
                ...
                formatButtonTextStyle: TextStyle(color: AppColors.textSecondary, fontSize: 11),
              ...
              daysOfWeekStyle: const DaysOfWeekStyle(
                weekdayStyle: TextStyle(fontSize: 10, color: AppColors.textSecondary),
                weekendStyle: TextStyle(fontSize: 10, color: AppColors.gold),
              ),
            ),
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(children: [
                    Container(
                      ...
                      child: Text(typeInfo?.label ?? event.typeKey, style: TextStyle(fontSize: 8, color: color, fontWeight: FontWeight.w600, letterSpacing: 0.5)),
                    ),
                    const Gap(6),
                    if (event.isDone) Container(
                      ...
                      child: const Text('DONE', style: TextStyle(fontSize: 8, color: AppColors.done)),
                    ),
                  ]),
                  const Gap(4),
                  Text(
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const Gap(14),
          // Date picker
          const Text('Date', style: TextStyle(fontSize: 10, color: AppColors.textSecondary, letterSpacing: 0.5)),
          const Gap(6),
          GestureDetector(
            onTap: _pickDate,
            child: Container(
          ...
          const Gap(14),
          // Event type
          const Text('Type', style: TextStyle(fontSize: 10, color: AppColors.textSecondary, letterSpacing: 0.5)),
          const Gap(6),
          Wrap(
            ...
            children: AppConstants.eventTypeKeys.map((k) {
              ...
              return GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  child: Text('${info?.emoji ?? ''} ${info?.label ?? k}', style: TextStyle(fontSize: 10.5, color: sel ? color : AppColors.textSecondary, fontWeight: sel ? FontWeight.w600 : FontWeight.w400)),
                ),
              );
            }).toList(),
          ),
