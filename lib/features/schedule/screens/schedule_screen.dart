        ...
        child: AnimatedContainer(
          ...
          child: InkWell(
            ...
            child: Padding(
              ...
              child: Row(children: [
                SizedBox(width: 44, child: Text(block.time, style: TextStyle(fontFamily: 'Roboto', fontSize: 10.5, fontWeight: FontWeight.w600, color: color))),
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(children: [
                    ...
                    if (isCurrent) Container(
                      ...
                      child: Text('NOW', style: TextStyle(fontFamily: 'Roboto', fontSize: 8, fontWeight: FontWeight.w700, color: color)),
                    ),
                  ]),
                ...
                if (block.duration != null) ...[
                  ...
                  Container(
                    ...
                    child: Text(block.duration!, style: TextStyle(fontFamily: 'Roboto', fontSize: 9, color: color)),
                  ),
                ],
                const Gap(8),
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const Gap(14),
          const Text('Category', style: TextStyle(fontSize: 10, color: AppColors.textSecondary, fontFamily: 'Roboto', letterSpacing: 0.5)),
          const Gap(6),
          Wrap(
            ...
            children: AppConstants.categoryKeys.map((k) {
              ...
              return GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  child: Text('${info?.emoji ?? ''} ${info?.label ?? k}', style: TextStyle(fontFamily: 'Roboto', fontSize: 11, color: sel ? color : AppColors.textSecondary, fontWeight: sel ? FontWeight.w600 : FontWeight.w400)),
                ),
              );
            }).toList(),
          ),
